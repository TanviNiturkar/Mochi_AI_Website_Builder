    ...
    return (
        <div className={cn("flex flex-col group px-2 pb-4", type==="ERROR" && "text-red-700 dark:text-red-500")}>
            <div className="flex items-center gap-2 pl-2 mb-2">
                <Image src='/logo1.png' alt="Mochi" width={38} height={18} className="shrink-0"/>
            ...
            <div className="pl-8.5 flex flex-col gap-y-4">
                ...
                <FragmentCard fragment={fragment} isActiveFragment={isActiveFragment} onFragmentClick={()=>onFragmentClick(fragment)}/>
                )}
            </div>
        </div>
    )
